const languagePack = [
  [
    "ukr",
    {
      ...
      infoLi1: "Прапор країни - мова додатку (можна обрати по замовчуванню)",
      infoLi2:
      ...
      infoLi5:
        ...
        infoLi6:
        "Подвійне натискання на назві міста у формі введення встановлює його по замовчуванню",
    },
  ],
  [
    "eng",
    {
      ...
      infoLi1: "Country flag - app language (can be chosen as default)",
      infoLi2:
      ...
      infoLi5:
        ...
        infoLi6:
        "Double click on city name inside the input form sets it as a default",
    },
  ],
];
